 ...
 * @author serch
 */
@WebServlet(name = "FormsAPIServlet", urlPatterns = {"/api/*"})
public class FormsAPIServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        try
        {
            ...
            request.getServletContext().getRequestDispatcher("/platform/jsp/api.jsp").include(request, wrapper);
